 ...
 * {@code MemoryUsage} are not thread-safe!
...
public final class MemoryUsage {
    ...
    /**
     * Returns true, if the current JVM is fully supported by {@code MemoryUsage}.
    ...
    /** Creates a new instance of {@code MemoryUsage} with intern checking
    ...
    /** Creates a new instance of {@code MemoryUsage}.
     ...
     */
    @Deprecated
    public MemoryUsage(boolean checkInterned) {
        this.checkInterned = checkInterned;
    }

    /** Creates a new istance of {@code MemoryUsage}.
     * @deprecated Don't create instances of this class, instead use the static
     * {@link #sizeOf(Object)} method.
     * @see #sizeOf(Object)
     */
